...
#define IM_VEC2_CLASS_EXTRA                                            \
  constexpr ImVec2(const orbitals::math::vec2& f) : x(f[0]), y(f[1]) { \
  }                                                                    \
  operator orbitals::math::vec2() const {                              \
    return orbitals::math::vec2(x, y);                                 \
  }

#define IM_VEC4_CLASS_EXTRA                                                              \
  constexpr ImVec4(const orbitals::math::vec4& f) : x(f[0]), y(f[1]), z(f[2]), w(f[3]) { \
  }                                                                                      \
  operator orbitals::math::vec4() const {                                                \
    return orbitals::math::vec4(x, y, z, w);                                             \
  }
